...
<Callout label="Interpretation">
  Cost of living only works if you're comparing locals like for like across the globe. This isn't really feasible.
</Callout>
...
## See it for yourself with the following interactive demo

The numbers and narrative above establish the pattern. The lab below lets you stress-test it.

This demo takes into account 
